...
A recent simulation study by @OBERMAN2020 found that conventional convergence diagnostics like $\hat R$ [@GELMAN1991] are too conservative for missing data imputation. When these diagnostics typically indicate convergence after only 30-40 iterations, the parameter estimates achieve their desired statistical properties between 5 and 10 iterations. It is, however, important not to rely uncritically on this result as some applications can require considerably more iterations.
